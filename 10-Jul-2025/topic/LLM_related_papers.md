...
**Abstract (ZH)**: LoRA的幅度驱动初始化方案：LoRAM及其优越性 
...
**Abstract (ZH)**: Gradientsys：一种基于类型化模型-上下文协议和ReAct动态规划环的下一代多Agent调度框架 
...
**Title (ZH)**: 妙趣横生：基于对比学习和音义嵌入的多agent词语玩法规则翻译 
