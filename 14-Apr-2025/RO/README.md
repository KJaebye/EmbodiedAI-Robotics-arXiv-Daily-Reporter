...
**Abstract (ZH)**: This paper描述了Pogobot：一种开源硬件平台，专门用于 swarm robotics 的研究。 
...
**Abstract (ZH)**: 人类与人类互动的心理模型和期望对人机互动的影响：以家庭机器人为例——了解失败时的人机沟通方式 
