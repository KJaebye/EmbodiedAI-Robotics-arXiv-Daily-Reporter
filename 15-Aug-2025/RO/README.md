...
**Abstract (ZH)**: 深度神经网络在重载地面移动机器人中的 hierarchical 控制策略：集成模型自由鲁棒自适应控制的安全合成 
