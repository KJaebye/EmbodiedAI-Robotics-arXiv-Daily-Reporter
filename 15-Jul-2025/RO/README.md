...
**Abstract (ZH)**: 自主驾驶情境感知对话式ADAS（SC-ADAS） 
...
**Abstract (ZH)**: 自主驾驶车辆在交通流中的拉格朗日控制：多分辨率混合专家学习 
...
**Abstract (ZH)**: 基于生成AI的多agent强化学习：从反应性到主动性的大范式变革 
...
**Title (ZH)**: 域适应和多视图注意力机制在稀疏数据学习地标跟踪中的应用 
