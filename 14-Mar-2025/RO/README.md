...
**Abstract (ZH)**: 基于任务驱动的移动机器人设计挑战与策略：整合感知与运动规划优化资源使用 
...
**Abstract (ZH)**: 虚拟观众界面（VSI）增强模拟搜索任务中的人机团队表现与态势感知 
