...
**Abstract (ZH)**: 基于原始传感器数据的Model-based Reinforcement Learning方法在端到端自动驾驶中的应用：Raw2Drive 
...
**Abstract (ZH)**: RIPT-VLA：基于稀疏二元成功率 reward 的简单可扩展的交互式后训练强化学习范式 
